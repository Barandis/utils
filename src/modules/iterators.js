 ...
 * If `inclusive` is true, then `end` itself will be included in the
 * range.
 *
 ...
 * itself should always be non-negative; if a negative `step` is
 * provided, its absolute value will be used instead. The direction of
 * the iteration is always determined by `start` and `end`.
 *
 * ### Examples
 *
 * ```javascript
 ...
 * const set = [...range(0, 4, 2)]
 * console.log(set)  // [0,2]
 *
 * const seti = [...range(0, 4, 2, true)]
 * console.log(seti) // [0,2,4]
 *
