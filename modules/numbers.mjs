...
/**
 * Converts a number to its string ordinal form (i.e., `1` becomes `'1st'`, `1729` becomes
 * `'1729th'`, etc.).
 *
...
/**
 * Converts a number into its word-based ordinal form (i.e., `1` becomes `'first'`, `1729`
 * becomes `'one thousand seven hundred twenty-ninth'`, etc.).
 *
 * @param {number} n The number to convert into an ordinal.
